...
#endif
{
	...
	unsigned long minor;
	int i;
	pr_err("[shimg1]: goodix gf_probe begin \n");
	...
	pr_err("[shimg1]: goodix gf_probe end \n");
	return status;
#ifdef AP_CONTROL_CLK
...
static int __init gf_init(void)
{
	 ...
	 */
	pr_err("[shimg1]: goodix gf_init begin \n");
	pr_info("[shimg1]: goodix gf_init begin \n");
	...
	pr_err("[shimg1]: goodix gf_init end \n");
	pr_info("[shimg1]: goodix gf_init end \n");
	return 0;
}
